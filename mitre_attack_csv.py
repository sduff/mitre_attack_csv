...
for t in o['x-mitre-tactic']:
	...
	tactics[short_name] = (name, id, url)
...
for tn in o['attack-pattern']:
	...
	kill_chain_phases = [x['phase_name'] for x in kill_chain_phases if x['kill_chain_name']=="mitre-attack"]
